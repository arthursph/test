...
export class TestService {
    ...
    public currentCategory: BehaviorSubject<Category> = new BehaviorSubject(
        null
    )
    public currentQuestion: BehaviorSubject<Question> = new BehaviorSubject(
        null
    )
    ...
    goToPreviousCategory() {
        this.setCurrentCategory(
            this.categories[
                this.categories.indexOf(this.getCurrentCategory()) - 1
            ].title
        )
    ...
    goToPreviousQuestion() {
        if (
            this.getCurrentQuestion() &&
            this.getCurrentQuestion().index === 1
        ) {
    ...
    calculateAnswerCo2e = answer => {
        ...
        switch (this.getCurrentQuestion().index) {
            ...
            case 5: {
                ...
                if (answer.index === 118) {
                    if (this.getResult().answers[3].answer.index === 115) {
                        ...
                        this.getResult().answers[3].answer.index === 116
                    ) {
                        ...
                        this.getResult().answers[3].answer.index === 117
                    ) {
            ...
            case 6: {
                switch (answer.index) {
                    ...
                    case 125:
                        ...
                        break
                    case 126:
                        answer.multiplier[0] = 1
                        break
                }

                if (answer.index === 126) {
                    // Answer "I don't know"
                    answer.co2e = $G$48() + $F$40()
                    answer.multiplier[1] = this.getResult().answers[4].answer.multiplier[1]
                } else {
                    answer.co2e =
                        answer.multiplier[0] *
                            $I$20() *
                ...
                if (answer.index === 130) {
                    answer.co2e =
                        ...
                        (this.getResult().answers[6].answer.co2e +
                            this.getResult().answers[5].answer.multiplier[1] *
                                this.getResult().answers[5].answer
                                    .multiplier[0])
                } else if (answer.index === 131) {
                    answer.co2e = 0
                } else if (answer.index === 132) {
                    answer.co2e =
                        0.1 *
                        (this.getResult().answers[6].answer.co2e +
                            this.getResult().answers[5].answer.multiplier[1] *
            ...
            case 9: {
                if (answer.index === 133) {
                    // About 30 minutes
                    if (this.getResult().answers[5].answer.index === 126) {
                        answer.co2e =
                            52 *
                            (0.00032 * (360 - 672) + (360 - 672) * 0.04 * 0.266)
                    } else {
                        answer.co2e =
                            52 *
                            (0.00032 * (360 - 672) +
            ...
            case 12: {
                ...
                const G87 =
                    this.getResult().answers[10].answer.multiplier[1] /
                    answer.multiplier
            ...
            case 15: {
                answer.co2e =
                    this.getResult().answers[13].answer.multiplier /
                    answer.multiplier
                return answer
            }
            // 3rd category
            ...
            case 26: {
                answer.co2e =
                    this.getResult().answers[24].answer.multiplier /
                    answer.multiplier
                return answer
            }
            default: {
