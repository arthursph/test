...
const calculate = (doc, month) => {
    ...
    if (doc.answers.length === 27) {
        month.done++
        month.co2e += doc.co2e
        month.categories[doc.categoryCO2e[0].category] +=
            doc.categoryCO2e[0].co2e
        month.categories[doc.categoryCO2e[1].category] +=
            doc.categoryCO2e[1].co2e
        month.categories[doc.categoryCO2e[2].category] +=
            doc.categoryCO2e[2].co2e
        month.categories[doc.categoryCO2e[3].category] +=
            doc.categoryCO2e[3].co2e

        total.done++
        total.co2e += doc.co2e
        total.categories[doc.categoryCO2e[0].category] +=
            doc.categoryCO2e[0].co2e
        total.categories[doc.categoryCO2e[1].category] +=
            doc.categoryCO2e[1].co2e
        total.categories[doc.categoryCO2e[2].category] +=
            doc.categoryCO2e[2].co2e
        total.categories[doc.categoryCO2e[3].category] +=
            doc.categoryCO2e[3].co2e
    } else {
        month.undone++
        total.undone++
