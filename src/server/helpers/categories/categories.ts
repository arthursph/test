...
const categories = [
    {
        ...
        endInfoPositive: {
            ...
            se:
                'Ditt hem och dina vanor förbrukar energi och är på rimlig nivå.'
        },
        endInfoNegative: {
            en:
        ...
        endInfoCommon: {
            en:
                'Now, let’s have a look at how you get from one place to another!',
    ...
    },
    {
        ...
        endInfoPositive: {
            en:
                'You use low-carbon transport and are hopefully getting fitter, too!',
    ...
    },
    {
        ...
        endInfoNegative: {
            en:
                ...
                'Hei sinä siellä! Olet oikea nautiskelija ja syöt miten huvittaa.',
    ...
    },
    {
        ...
        resultInfo: {
            ...
            positiveDescription: {
                ...
                se:
                    'Du förstår hur dina val inverkar på din livsstil och miljön.'
            },
            negativeDescription: {
                en:
