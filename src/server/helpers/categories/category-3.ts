...
const cat3qs = [
    ...
    },
    {
        ...
        title: {
            en:
                'How often do you have red meat (beef, pork, cold cuts) or cheese as part of your meal?',
            fi:
                'Kuinka usein yhteensä nautit aterioillasi punaista lihaa (nauta, possu, leikkeleet) tai juustoa?',
            se:
                'Hur ofta äter du rött kött (nötkött, svinkött, charkuterier) eller ost under måltiderna?'
        },
        answers: q18as
    },
    {
        ...
        title: {
            en:
                'How often do you have chicken, fish or eggs as part of your meal?',
            fi:
                'Kuinka usein yhteensä nautit aterioillasi kanaa, kalaa ja kananmunaa?',
            se: 'Hur ofta äter du kyckling, fisk och ägg under måltiderna?'
        },
        answers: q19as
    },
    {
    ...
    },
    {
        ...
        title: {
            en:
                'How many meals per week do you eat out or in a canteen at work?',
            fi:
